...
export default function Scanner({ onChat }: { onChat?: (detectedWord: string, imageDataUrl: string) => void }) {
		...
		<div style={styles.container}>
			...
			<div style={styles.hero}>
				...
				<p style={styles.description}>
					VueLocale helps you level up your French speaking skills by engaging in spontaneous conversations about the
					world around you. Capture an object, and your AI companion will start chatting with you naturally!
				</p>
			</div>
